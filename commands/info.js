...
export const execute = async (client, interaction, isMod, isAdmin) => {
  ...
  const activeProfiles = profiles.filter(profile => !profile.suspended)
    ...
    .addField("GitHub (Source code)", "Currently unlisted", true)
    .addField("Submitting feature requests and bug reports", "Please do those on the [github page](https://github.com/404).", true)
